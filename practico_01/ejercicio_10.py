...
def tiene_pares_for_else(numeros: Iterable[int]) -> bool:
    ...
    for n in numeros:
        if n % 2 == 0:
            # Encontramos un par, salimos del bucle.
            break
    else:
        # El bucle terminó sin encontrar un par (nunca se hizo break).
        return False
    
    # Esta línea solo se alcanza si se hizo break.
    return True    
...
def tiene_pares_any(numeros: Iterable[int]) -> bool:
    ...
    return any(n % 2 == 0 for n in numeros) #expresion generadora
